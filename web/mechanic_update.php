...
include("conn.php");
$id = $_SESSION['id'];
$sql_ = "SELECT * FROM mechanics where id='$id'";
...
if (isset($_POST['save_btn'])) {
  ...
  $services_ = $_POST['services'];
  $city_ = $_POST['city'];
  $sql = "UPDATE mechanics SET name='$username_',email='$email_',phone='$phone_',password='$password_',services='$services_',address='$address_',city_id='$city_' where id='$id' ";
...
<body style="background-image: url('images/bg.jpeg');background-size: cover;background-repeat:no-repeat;height:100vh" class="gray-bg">
  ...
  include('header.php');
  ?>
  <form action="mechanic_update.php" method="post" enctype="multipart/form-data">
    <div class="container-fluid justify-content-center w-75 mt-5 p-4" style="border-color: #fff;border-style: solid;border-radius: 35px;background:#fff">
      ...
      <div class="row justify-content-center mt-2">
        ...
        <div class="col-6" style="text-align: center;">
          <input name="address" class="p-2 w-100" type="text"   value="<?php echo $address; ?>" required> </input>
        </div>
      </div>
      ...
      <div class="row justify-content-center mt-2">
        ...
        <div class="col-6" style="text-align: center;">
          <input name="services" class="p-2 w-100" type="text"   value="<?php echo $service; ?>" required> </input>
        </div>
      </div>
