        ...
        <div class="col-12">
            <table style="background: white;width: 100%;text-align: center;direction: ltr;" class="table">
                <tr>
                    ...
                    <th>
                        <a href="add_symptom.php"><i style="color:#004E7C;" class="fa fa-plus-circle"></i></a>
                    </th>
                </tr>
                <?php
                foreach ($query as $row) {
                    ...
                    $sql_issue = "SELECT * FROM issues WHERE symptom_id = $symptom_id";
                    $query_issue = mysqli_query($db,$sql_issue);
                    $count_issues = mysqli_num_rows($query_issue);
                    if($count_issues == 0) {$status = "no reply";}
                    if($count_issues != 0) {$status = "$count_issues reply";}
