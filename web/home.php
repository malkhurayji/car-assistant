          ...
          <nav class="navbar navbar-expand-lg custom_nav-container ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="login.php?type=mechanics"> Mechanic Login</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="login.php?type=users">User Login</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="login.php?type=admins">Admin Login</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#"><img src="images/logo.png" style="height: 3.0em;width: 8.0em;"></a>
                </li>
        ...
        <div class="row">
          <div class="col-md-6 ">
            ...
            Car    Services
              ...
              <p>
Welcome to our website you can use it to publish your symptoms and find issues
              </p>
              <a href="">
Car Assistant
              </a>
          ...
          <div class="col-md-6">
            <div class="img-box">
              <img src="style/images/slider-img.png" alt="">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-5 col-md-6">
          <div class="detail-box">
            ...
            <p>
              Welcome to our site you can use this site to add your issues and repair your car by mechanics from your home
            </p>
            <a href="">
              Read More
            </a>
        ...
        <div class="col-lg-7 col-md-6">
          <div class="img-box">
            <img src="style/images/about-img.jpg" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container ">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-6 mx-auto">
          <div class="box ">
            <div class="img-box">
              <img src="style/images/s1.png" alt="" />
            </div>
            <div class="detail-box">
              <h5>
              Car  Maintenance
        ...
        <div class="col-sm-6 col-md-6 mx-auto">
          <div class="box ">
            <div class="img-box">
              <img src="style/images/s2.png" alt="" />
            </div>
            <div class="detail-box">
              <h5>
             Car   Electrical
  ...
  <section class="client_section ">
    <div class="container">
      ...
      <div class="carousel-wrap layout_padding2-top ">
        ...
        <?php
$sql_mechanics = "SELECT * FROM mechanics";
$query_mechanics = mysqli_query($db,$sql_mechanics);
$r = 0;

foreach($query_mechanics as $row_mechanic)
{
  $mechainc_name = $row_mechanic['name'];
  $mechainc_id = $row_mechanic['id'];
  $i=0;
  $sum = 0;
$sql_rates = "SELECT * FROM rates WHERE mechanic_id = $mechainc_id";
$query_rates = mysqli_query($db,$sql_rates);
foreach($query_rates as $row_rate)
{
$sum = $row_rate['rate'];
$i++;
}
