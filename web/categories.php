        ...
        <div class="col-12">
            <table style="background: white;width: 100%;text-align: center;direction: ltr;" class="table">
                <tr>
                    ...
                    <th>
                        <a href="add_category.php"><i style="color:#004E7C;" class="fa fa-plus-circle"></i></a>
                    </th>
                </tr>
                <?php
                ...
                ?>
                    <tr>
                        <td><?= $row['name']; ?></td>
                        <td>
                        <a class="btn btn-primary" href="./update_category.php?id=<?= $row['id']; ?>">update</a>
                        <a class="btn btn-danger" href="./categories-delete.php?id=<?= $row['id']; ?>">delete</a>
                        </td>
                        <td></td>
                    </tr>
                <?php
