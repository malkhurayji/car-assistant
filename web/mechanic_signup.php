...
if (isset($_POST['register_btn'])) {
	...
	$city = $_POST['city'];
	$_SESSION['type'] = 'mechanics';
	$sql = "INSERT INTO mechanics(name,password,email,phone,services,address,city_id)
	 VALUES('$name','$password','$email','$phone','$services','$address',$city)";
	if (mysqli_query($db, $sql)) {
		$id = mysqli_insert_id($db);
		$_SESSION['id'] = $id;
		echo '<script>alert("mechanic created successfully,welcome to our website")</script>';
	} else {
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg.jpeg');">
			<div class="wrap-login100" style="background: -webkit-linear-gradient(top,#003E7C,#27C1F5);">
				<form enctype="multipart/form-data" action="mechanic_signup.php" method="post"
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input minlength="8" class="input100" type="password" name="password" placeholder="Password"
							required>
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="Enter services">
						<input class="input100" type="text" name="services" placeholder="services" required>
						<span class="focus-input100" data-placeholder="&#9974;"></span>
					</div>
